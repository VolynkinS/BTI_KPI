...
SECRET_KEY = 'django-insecure-ejkne(=3ih-5yegp#ag7y2t5d2l0rqb5e^ei3+qkh08iln7ryv'
...
INSTALLED_APPS = [
    ...
    # django.contrib.sites is recommended to install always, in each project
...
# For django.contrib.sites to work properly
SITE_ID = 1
